...
/**
 * The event fired after an Action rule has executed.
 */
public class LogicAfterActionEvent extends LogicEvent {

	private ActionRule actionRule;

	public LogicAfterActionEvent(LogicTransactionContext context, LogicContext logicContext, 
		...
		eventType = EventType.AFTER_ACTION;
	}

	/**
	 * The action that has been fired.
	 */
	...
	private final static String SVN_ID = "$Id: Version 2.1.5 Build 0602 Date 2012-04-28-14-13  LogicAfterActionEvent.java 83 2011-12-12 19:58:05Z max@automatedbusinesslogic.com $";
}
