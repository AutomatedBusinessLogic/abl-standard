...
/**
 * Derives the maximum value for a given attribute among child objects that satisfy an optional clause.
...
public @interface Maximum {
   ...
   /**
	 ...
	 * </ol>
	 * If omitted, no other arguments are allowed,
	 * and you must then specify this as the (un-named) argument.
	 */
	String value();
}
